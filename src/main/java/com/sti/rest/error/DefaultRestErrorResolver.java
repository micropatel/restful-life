...
public class DefaultRestErrorResolver implements RestErrorResolver, MessageSourceAware, InitializingBean {
    ...
    private static final Log log = LogFactory.getLog(DefaultRestErrorResolver.class);
    ...
    private void applyDef(Map<String,String> m, @SuppressWarnings("rawtypes") Class clazz, HttpStatus status) {
    ...
    private int getDepth(String exceptionMapping, @SuppressWarnings("rawtypes") Class exceptionClass, int depth) {
